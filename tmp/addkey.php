<?php
			$result .= '<div class = "fs3 promo">
							<div class = "videoZag">
								<div class="obolochka">
									<div class="centredv lh32">'.$zag.'</div>
								</div>
							</div>';
				...
				$result .='<div class = "videoVvod">
								<input class ="input w100 mt10 mb10" type="text" name="'.$value.'" placeholder="'.$placeholder.'">
							</div>
							<div class = "videoKnopka">
								<button class="Knopka w100 mt10 mb10 biYellow" name="send" id="'.$buttonid.'" type="submit">'.$textButton.'</button>
							</div>';
			$result .= '</div>';
?>