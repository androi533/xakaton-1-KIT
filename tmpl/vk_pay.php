...
$secret_key = 'tlT97WJ4gCohyynPVOcy'; // Защищенный ключ приложения 
    ...
    case 'get_item': 
      ...
      if ($item == 'test') { 
        $response['response'] = array( 
          'item_id' => 1, 
          'title' => 'Один день', 
          'photo_url' => 'https://pp.userapi.com/c824202/v824202989/1685f8/iTBqBsWIqAY.jpg', 
          'price' => 41
        ); 
      } elseif ($item == 'key') { 
        $response['response'] = array( 
          'item_id' => 2, 
          'title' => 'Под ключ', 
          'photo_url' => 'https://pp.userapi.com/c848732/v848732989/e7a2/z7708e_y_o8.jpg', 
          'price' => 4444 
        ); 
      } else { 
        $response['error'] = array( 
